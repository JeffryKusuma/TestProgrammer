...
@section('content')
    <div class="col-md-12">
    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('users.update', $data->id) }}" method="POST">
         @csrf
         @method('PUT')
        <div class="input-group mb-3">
            
            <input type="text" id="name" name="name" class="form-control" value="{{$data->name}}" placeholder="Full Name" />
